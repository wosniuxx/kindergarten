...
<body>
	<div id="section1" init="true" class="section section1">
		...
		<!--partner-->
		<div id="section6" init="false" class="section section6" align="center">
						...
						<form class="form-inline" id="SearchForm">
							<div class="form-group">
								<label for="tel">手机号码:</label> <input type="text"
									class="form-control inpu-sm" name="tel"  value='5'/>
							</div>
...
<script src="<%=webpath%>/resources/js/recruit/recruitResult.js"
