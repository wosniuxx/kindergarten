...
<body>
	                    		...
	                    		<form id="urlmodelAddForm" data-validator-option="{timely:2, theme:'yellow_right'}">
		                    		...
		                    		<div class="form-group">
  									...
  									<div class="form-group">
    									...
    									name="sign" id="sign" value="hpCheckLogin" readonly="readonly" />
  									</div>
  									<div class="form-group">
  									...
  									<button type="button" class="b-redBtn btn-i" id="getUrlYunBtn"><i class="iconfont">&#xe635;</i>接口预览</button>
								</form>
	               			</div>
  					</div>
			 </div>
	...
	<script src="<%=webpath %>/resources/js/sso/urlModelyun_add.js"></script>
