...
<body>
	<div class="row">
	     <div class="col-lg-12 col-md-12 row-tab">
	         <div id="org-panel" class="panel panel-default common-wrapper">
  					<div class="panel-heading common-part"><i class="iconfont">&#xe6ca;</i><span>云门户接口注册</span>
	                    		...
	                    		<form class="form-inline" id="urlexplainAddForm" data-validator-option="{timely:2, theme:'yellow_right'}">
		                    		...
		                    		<div class="form-group">
  									...
  									<div class="form-group">
    									...
    									<input type="text" class="form-control input-sm" style="width:125px"  name="sign" id="sign" value="hpCheckLogin" readonly="readonly"/>
  									</div>
  									<div class="form-group">
  									...
  									<div class="form-group">
    									...
    									<input type="text" class="form-control input-sm" style="width:125px"  name="getUserUrl" id="getUserUrl" value="云门户" readonly="readonly"/>
  									</div>
  									<button type="button" class="b-redBtn btn-i" id="addYunUrlBtn"><i class="iconfont">&#xe635;</i>接口预览</button>
								</form>
	               			</div>
	               			<img src="<%=webpath %>/resources/img/sso/Red2.jpg" class="arrowimg">
	               			<div class="showUrl" id="showUrl">
	               			 	<div class="conurl"></div>
	               			 	<button type="button" class="b-redBtn btn-i" id="okyunbtn"><i class="iconfont">&#xe8c1;</i>生成</button>
	               			</div>
  					</div>
			 </div>
	     </div>
	...
	<script src="<%=webpath %>/resources/js/sso/urlexplainyun_add.js"></script>
