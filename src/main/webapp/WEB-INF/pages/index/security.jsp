...
<body>
	<div id="section1" init="true" class="section section1">
		...
		<div id="section6" init="false" class="section section6">
					...
					<br />
					<p>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;空气、生活用水等必需品可满足食品安全卫生体系。园内舍友高空防护网，可防止高空坠物，以及防坠落。
       					园区内的配备有多样的安全设施，如烟雾警报器、灭火器、消防应急通道等。同时也出台各项安全措施，
       					从园长到各个班级的教师，首要关注的就是孩子们的安全问题。
       					园内保安配备对付歹徒用的警棍、电棍、叉圈等。可以最大限度的保证孩子的安全。
       					以下是我园的安全手册：
					</p><br />
       					<p>一、幼儿园常用游戏器材安全要求</p>
       					<p>二、幼儿常见意外的防范手册（烫伤、外伤等）</p>
       					<p>三、我园安全工作的对策</p>
       				<br />
				</div>
			</div>
