...
<body>
	<div id="section1" init="true" class="section section1">
		...
		<div id="section6" init="false" class="section section6">
					<div align="center" style="height: 50px;width: 100%;background-color: #2eafbb;">
					<span style="font-family: '微软雅黑';font-size: 20px;color: #ffffff;line-height: 50px">一切为了孩子，为了孩子一切，为了一切孩子</span>
					</div>
					<br /><br /><br /><br />
					<h1 align="center">太原市幼儿园</h1>
					<div style="font-size: 18px;font-family: '微软雅黑';width: 800px;margin-left: 22%;line-height: 35px;">
					<br />
					<p>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;太原市幼儿园建于1975年，是太原市教育局直属的一所全日制幼儿园，占地面积7229M2，建筑面积5309M2，
						是国家级文明单位、国家教委十•五科研项目“双语实验重点基地”、太原市“四星级幼儿园”,
						先后被授予山西省劳动模范集体、省级文明单位、市行风“双评”活动最佳单位和健康•卫生•安全学校•……现有教职工105人，
						其中教师73人，大部分取得了太原市双语教师资格证书，
						其他各岗人员参加专业培训率达80%。全园现开设12个班,共容纳幼儿近400名。
						每班有配套的大屏幕彩电、钢琴、放相机、投影仪、语言复读机、洗衣机、热水器、消毒柜及双向闭路监控等设施。
					</p><br />
       				<p>
       					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;遵循《幼儿园教育纲要》精神，为幼儿提供健康、丰富的生活和活动环境，我们为幼儿开辟了语音室、电子琴室、棋类室、亲子屋、操作间、小画室等14个幼儿专用活动室，
	       				置身于这样的环境，幼儿懂得了亲近自然，爱护动物，知道了人与自然应和谐共处。
	       				安全是幼儿生命和生活的保证，因此，室外的游乐场我们配有安全性极高的全塑大型玩具，
	       				室内的玩具、桌椅、玩具架均是进口全塑的，既轻便又安全，所有幼儿活动场所的地面包括长廊，
	       				楼梯都是碟晶石软地板，为幼儿提供了最优化的学习和生活环境。
       				</p><br />
       				<p>
     					 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 多年来，我园逐步形成了“尊重、合作、创新、发展”的园风，明确了“以人为本，为人的终身发展奠基”的办园思想，
     					  构建了一支高素质的教工队伍，先后有20余人次受到国家、省、市、区级的表彰；承担了五项国家级、四项省、市级实验研究，
     					  二百余篇论文刊登、获奖；有10多本论著出版，其中《幼儿英语》系列丛书全国发行；
     					  多次承担了省、市级的幼儿园双语教师的培训，受到同行们的一致好评；500余名幼儿先后在国内外美术、声乐等大赛中获奖。
     					  经过多年的努力，我园还建起了校园教学、办公的现代信息教育系统，开通了国际互联网，
     					  方便了教师查询资料，获取信息，制作课件，实现了网络化教育教学与管理。目前我园正以发展的眼光，拼搏的勇气，向着更高的目标迈进。
					</p>	
					<br /><br />
				</div>
			</div>
