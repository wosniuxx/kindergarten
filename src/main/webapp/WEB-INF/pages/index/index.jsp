...
<body>
	...
	<div id="section3" init="false" class="section section3">
					...
					<div class="home_news_list_inner">
						...
						<div class="home_news_item">
							<dl>
								...
								<dd class="spec">
									<a>
										日月穿梭,寒署交替，悠然间岁月的年轮在不经意中又多划了一个圈，在我们共同度过的这365个日子里，
										我们一同体验了春的温暖、夏的火热、秋的丰硕和冬的美丽，并以期盼的心情满怀喜悦的迎接充满希望的2017年
									</a>
								</dd>
							</dl>
						</div>
						<div class="home_news_item">
							<dl>
								...
								<dd class="spec">
									<a>
										亲爱的小朋友们，“六一”的阳光，“六一”的鲜花，“六一”的蓝天，都在为你们祝福……“六一”是快乐的，
										让我们中心园的全体小朋友们一起来用甜甜的歌声、优美的舞蹈、好听的故事大胆地表达自己的快乐心情
									</a>
								</dd>
							</dl>
						</div>
						<div class="home_news_item">
							<dl>
								...
								<dd class="spec">
									<a>
									 为了让家长更好地了解孩子在幼儿园的学习、生活情况，
									 增进幼儿园、教师、家长之间的联系与沟通，更好地达到家园共育目的。
									 2017月4月25日，我园举行了本学期家长开放日活动，邀请家长走进幼儿园，参与各项活动。
									</a>
								</dd>
							</dl>
						</div>
		...
		<div class="btn_cases_more">
			<a href="<%=webpath%>/publicNotice/index" title="查看更多" class="btn"> 查看更多 </a>
		</div>
	</div>
