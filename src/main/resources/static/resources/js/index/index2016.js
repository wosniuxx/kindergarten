...
$(document).ready(function () {
    ...
    $("#list_pic li").hover(function () {
        ...
        setPosition($obj);
        $pic.animate({left: -width * index}, 600, function () {
            picScroll($obj)
        });
    ...
    $('.thumbnail_a').hover(function () {
        $(this).children('.projectinfo').fadeIn('fast', function () {
            $(this).children('.meta').animate({bottom: 0 + "px"})
        })
    }, function () {
        $(this).children('.projectinfo').fadeOut('fast', function () {
            $(this).children('.meta').animate({bottom: -60 + "px"}, 1)
        })
    });
    ...
    var $obj6 = $('.section6');
    var time = 1200;
    $obj2.find('.home_title').animate({top: '0'}, 1500, 'easeOutExpo');
    $obj2.find('.service_text').animate({left: '0'}, 1500, 'easeOutExpo');
    $obj2.find('.serve_column').animate({bottom: '0'}, 1500, 'easeOutExpo');
    $obj3.find('.succeed_title').css({position: "relative"}).animate({top: '-220px'}, time, 'easeOutExpo');
    $obj3.find('.success_text').css({position: "relative"}).animate({left: '-110%'}, time, 'easeOutExpo');
    $obj3.find('.portfolio-grid').css({position: "relative"}).animate({bottom: '-1000px'}, time, 'easeOutExpo');
    $obj4.find('.home_solutions_title').css({position: "relative"}).animate({left: '-120%'}, time, 'easeOutExpo');
    $obj4.find('.home_solutions_text').css({position: "relative"}).animate({right: '-120%'}, time, 'easeOutExpo');
    $obj4.find('.home_solutions_list').css({position: "relative"}).animate({top: '-600px'}, time, 'easeOutExpo');
    $obj5.find('.home_news_title').css({position: "relative"}).animate({bottom: '-500px'}, time, 'easeOutExpo');
    $obj5.find('.home_news_text').css({position: "relative"}).animate({right: '-110%'}, time, 'easeOutExpo');
    $obj5.find('.home_news_list').css({position: "relative"}).animate({left: '-110%'}, time, 'easeOutExpo');
    $obj6.find('.home_partner_title').css({opacity: 0.2});
    $obj6.find('.home_partner_text').css({opacity: 0.2});
    $obj6.find('.home_partner_list').css({opacity: 0.2});
        ...
        $(that).bind({
            mouseenter: function () {
                item4Timer = setTimeout(function () {
                    ...
                    $(that).find('img').animate({'width': width, 'height': height, 'top': -20, 'left': -27}, 500)
                }, 200)
            }, mouseleave: function () {
...
$(window).scroll(function () {
    ...
    $.each(boxElemets, function () {
        ...
        if (otop < docViewBottom) {
            ...
            var delay = 0;
            if (sid == "section3") {
                $obj3.find('.succeed_title').css({position: "relative"}).delay(delay).animate({top: '0'}, 1500, 'easeOutExpo');
                $obj3.find('.success_text').css({position: "relative"}).delay(delay).animate({left: '0'}, 1500, 'easeOutExpo');
                $obj3.find('.portfolio-grid').css({position: "relative"}).delay(delay).animate({bottom: '0'}, 1500, 'easeOutExpo');
            } else if (sid == "section4") {
                $obj4.find('.home_solutions_title').css({position: "relative"}).delay(delay).animate({left: '0'}, 1500, 'easeOutExpo');
                $obj4.find('.home_solutions_text').css({position: "relative"}).delay(delay).animate({right: '0'}, 1500, 'easeOutExpo');
                $obj4.find('.home_solutions_list').css({position: "relative"}).delay(delay).animate({top: '0'}, 1500, 'easeOutExpo');
            } else if (sid == "section5") {
                $obj5.find('.home_news_title').css({position: "relative"}).delay(delay).animate({bottom: '0'}, 1500, 'easeOutExpo');
                $obj5.find('.home_news_text').css({position: "relative"}).delay(delay).animate({right: '0'}, 1500, 'easeOutExpo');
                $obj5.find('.home_news_list').css({position: "relative"}).delay(delay).animate({left: '0'}, 1500, 'easeOutExpo');
            } else if (sid == "section6") {
                $obj6.find('.home_partner_title').delay(delay).animate({opacity: 1});
                $obj6.find('.home_partner_text').delay(delay).animate({opacity: 1});
                $obj6.find('.home_partner_list').delay(delay).animate({opacity: 1});
            }
        }
    });
    var docViewTop = $(window).scrollTop();
...
function setPosition($obj) {
    ...
    $title.find("img").css({position: "relative", left: -width / 2 - wTitle / 2});
    $info.find("img").css({position: "relative", left: width / 2 + wInfo / 2});
    $first.css({position: "relative", left: -width / 2 - wText / 2});
    $last.css({position: "relative", left: width / 2 + wText / 2});
    $text.find("img:eq(1)").css({opacity: 0})
}
function picScroll($obj) {
    ...
    var $first = $text.find("img:first-child");
    var $last = $text.find("img:last-child");
    $title.find("img").animate({left: 0}, 1000);
    $info.find("img").animate({left: 0}, 1000);
    $text.find("img:eq(1)").animate({opacity: 1}, 800, function () {
        $first.animate({left: 0}, 400);
...
function nav($obj) {
    ...
    $obj.find(".nav_icon").css({left: left, width: width})
}